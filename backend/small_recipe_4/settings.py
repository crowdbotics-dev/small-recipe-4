"""
Django settings for small_recipe_4 project.
...
ROOT_URLCONF = 'small_recipe_4.urls'
...
WSGI_APPLICATION = 'small_recipe_4.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Small Recipe Support <support@small-recipe-4.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "small_recipe_4 API",
    "DESCRIPTION": "API documentation for small_recipe_4 App",
    "VERSION": "v1",
}
